...
function setHomeTabs(me, container, extclass){
  ...
  for (i = 0; i < arrayLength; i++) {
    ...
    if (icon == '') {
      icon = '/static-inbuilt/go-monolith/assets/admin/images/icons/'+lowercase_name+'.png';
    }
    withribbon = "";
    ...
    content += withribbon;
    content += '      <center><br>';
    content += '        <img onerror="this.src=\'/static-inbuilt/go-monolith/assets/admin/images/icons/model.png\';" src="'+icon+'"';
    if (tooltip != ""){
...
function setHeaderTabs(me, container, extclass){
  ...
  lowercase_name = me[i].toLowerCase();
    ...
    content += '      <center>';
    content += '        <img src="/static/go-monolith/assets/admin/images/icons/small/'+me[i].toLowerCase()+'.png"';
    content += '      </center>';
...
$(document).ready(function() {
  ...
  $("body").append('<script src="/static-inbuilt/go-monolith/js/notify.min.js"></script>');
});
